...
if string.match(ww, 'شهاب')  or  string.match(ww, 'شهيب') or  string.match(ww, 'شهوب') or  string.match(ww, 'شهابو')  or string.match(ww, 'اشهيب') then
